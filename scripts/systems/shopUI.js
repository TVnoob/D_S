...
function openShopsenntakuUI(player) { // playerは@p
  const form = new ActionFormData()
      ...
      .button("通常shop商品","リソースパックの方のテクスチャのパス")
      .button("メンバーズショップ商品","リソースパックの方のテクスチャのパス");
...
function testOpenUI(player) {
    const form = new ActionFormData()
        .title("Shop")
        .body("通常shop商品")
        .button("§b攻略本","リソースパックの方のテクスチャのパス")
        .button("§b水晶玉","リソースパックの方のテクスチャのパス")
        .button("§b名札","リソースパックの方のテクスチャのパス")
        .button("木刀","リソースパックの方のテクスチャのパス")
        .button("小さな鍵","リソースパックの方のテクスチャのパス")
        .button("拡声器","リソースパックの方のテクスチャのパス") // ここでフォーム5
        .button("§2汚いハートの器","リソースパックの方のテクスチャのパス")
        .button("§b足が速くなるクスリ","リソースパックの方のテクスチャのパス")
        .button("§7煙幕","リソースパックの方のテクスチャのパス")
        .button("§4戦いの律動","リソースパックの方のテクスチャのパス")
        .button("§b巨人の勇気","リソースパックの方のテクスチャのパス")
        .button("§gスペルシールド","リソースパックの方のテクスチャのパス")
        .button("§6粘着ボール","リソースパックの方のテクスチャのパス")
